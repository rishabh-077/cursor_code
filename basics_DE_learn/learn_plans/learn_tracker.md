...
| Field | Value |
|-------|--------|
| DE experience | 3.5 years · Tiger Analytics · Accenture |
| Clients | Lowe’s, Endeavour Group |
| CTC | ~25 LPA → **35–42** (primary) → **42–50** (strong) → **50–60+** (stretch, Tier A) |
| Notice | 2 months |
| Location | Remote preferred · Hyd · Blr · Pune · Mumbai |
| Targets | Google, Walmart GTC, Databricks, Snowflake, Fivetran, Razorpay, JPM, Chase |
| Daily study | 3–4 hours |

Full detail: [profile.md](./profile.md)
...
## Weekly completion (tick when week exit done)
...
| Milestone | Target week | Date (approx) | Done |
|-----------|-------------|---------------|:----:|
...
| **50–60+ LPA** | Stretch — see [profile](./profile.md#stretch-50–60-lpa) | | ⬜ |
...
| # | Story | File |
|---|--------|------|
| 1 | Vertex AI / Gemini — Endeavour | [endeavour_gemini_story.md](../behavioral/endeavour_gemini_story.md) |
| 2 | Pipeline whiteboard | [pipeline_whiteboard_template.md](../behavioral/pipeline_whiteboard_template.md) |
| 3–8 | BQ cost, dbt, Composer, Lowe’s, Accenture… | Fill in profile / behavioral |
